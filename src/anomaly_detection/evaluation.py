"""Offline-only SPEC-EVAL vocabulary and validation.

The production runtime must never import this module. Keeping evaluation truth in
one removable module makes the dependency boundary easy to inspect and test.
"""
...
def eval_schema_root() -> Path:
    return Path(__file__).with_name("data") / "schemas" / "spec_eval"
