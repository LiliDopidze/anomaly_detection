...
from telemetry_eval_contract import EVAL_CONTRACT_VERSION, validate_eval_bundle
...
GENERATOR_FEC_LINE_RATE_BPS = 2_488_000_000.0
GENERATOR_CRC_REFERENCE_RATE_BPS = 78_000_000.0
...
class SyntheticGponAdapter:
    ...
    def adapt_telemetry(self, panel, *, cadence_seconds: float | None = None):
        ...
        ] = GENERATOR_FEC_LINE_RATE_BPS * cadence_seconds
        long.loc[
            long["metric_id"].eq("telecom.link.crc_errors"), "exposure"
        ] = GENERATOR_CRC_REFERENCE_RATE_BPS * cadence_seconds
