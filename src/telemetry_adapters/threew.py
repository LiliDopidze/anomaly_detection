...
from telemetry_packs.oil_well import NATIVE_METRIC_FIELDS, OilWellPack, load_pack
...
class ThreeWAdapter:
    ...
    def materialise(
        ...
        *,
        ...
        for part_index, summary in enumerate(selected):
            frame = self._read_instance(summary)
            telemetry = self._telemetry(frame, summary)
